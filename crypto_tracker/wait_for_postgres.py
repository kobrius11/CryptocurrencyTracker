...
config = {
    "dbname": os.getenv("POSTGRES_DB", local_settings.POSTGRES_DB),
    "user": os.getenv("POSTGRES_USER", local_settings.POSTGRES_USER),
    "password": os.getenv("POSTGRES_PASSWORD", local_settings.POSTGRES_PASSWORD),
    "host": os.getenv("POSTGRES_HOST", local_settings.POSTGRES_HOST),
    "port": os.getenv("POSTGRES_PORT", local_settings.POSTGRES_PORT)
}
